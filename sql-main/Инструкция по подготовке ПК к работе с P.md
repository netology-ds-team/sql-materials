...
![Кнопка перехода в раздел скачивания на сайте DBeaver](/resources/InstallDbeaver/DBeaverDownloadButton.png)
...
![Список скачиваемых версий DBeaver](/resources/InstallDbeaver/DBeaverDownload.png)
...
![Выбираем DBeaver Windows(installer)](/resources/InstallDbeaver/DBeaverWindowsInstaller.png)
...
![Нажимаем далее](/resources/InstallDbeaver/Dbeaver1.png)

Принимаем лицензионное соглашение, нажав “Принимаю” (можете прочитать, если хотите =_=)

![Принимаем соглашение](/resources/InstallDbeaver/Dbeaver2.png)
...
![Выставляем Dbeaver Community, Include Java, Associate .SQL files](/resources/InstallDbeaver/Dbeaver3.png)

После чего нам необходимо выбрать папку установки Dbeaver (желательно использовать предложенную). Нажимаем “Далее >”

![Выбираем путь установки DBeaver](/resources/InstallDbeaver/Dbeaver4.png)

В следующем окне жмем “Установить”.

![Нажимаем установить](/resources/InstallDbeaver/Dbeaver5.png)
...
![Portable Version (Windows(zip))](/resources/InstallDbeaver/PortableDBeaver.png)
...
![Запусктите dbeaver.exe в разархивированной папке](/resources/InstallDbeaver/PortableDBeaver1.png)
...
![Выбирайте версию выше 12 для вашей ОС](/resources/InstallPostgreSQLServer/PostgreSQLDownload.png)
...
![Установка MVC](/resources/InstallPostgreSQLServer/MVC.png)

Далее произойдет открытие инсталлятора PostgreSQL Server, необходимо нажать “Next”

![Нажимаем Next >](/resources/InstallPostgreSQLServer/PostgreSQL1.png)

Выберите необходимый путь установки (лучше использовать предложенный)

![Выберите путь установки](/resources/InstallPostgreSQLServer/PostgreSQL2.png)

Далее выберите следующие пункты, изображенные на скриншоте

![Выбираем PostgreSQL Server + Command Line Tools](/resources/InstallPostgreSQLServer/PostgreSQL3.png)


Выберите место хранения PostgreSQL Server (лучше использовать стандартное)

![Выбираем место хранения PostgreSQL Server](/resources/InstallPostgreSQLServer/PostgreSQL4.png)
...
![Указываем пароль](/resources/InstallPostgreSQLServer/PostgreSQL5.png)

Введите номер порта для подключения к серверу и нажмите Next (введите 5432, он считается стандартным):

![Указываем порт подключения к серверу](/resources/InstallPostgreSQLServer/PostgreSQL6.png)

Нажмите Next

![Нажимаем Next](/resources/InstallPostgreSQLServer/PostgreSQL7.png)

Нажмите Next

![Нажимаем Next](/resources/InstallPostgreSQLServer/PostgreSQL8.png)

Нажмите Next и дождитесь окончания установки

![Нажимаем Next](/resources/InstallPostgreSQLServer/PostgreSQL9.png)

Нажмите Finish

![Нажимаем Next](/resources/InstallPostgreSQLServer/PostgreSQL10.png)
...
![Проверяем в диспетчере задач наличие процессов PostgreSQL Server](/resources/InstallPostgreSQLServer/PostgreSQL11.png)
...
![Открываем DBeaver и нажимаем кнопку "Новое соединение"](/resources/Backup/Backup1.png)

Выберите PostgreSQL и нажмите Далее

![Выбираем PostgreSQL](/resources/Backup/Backup2.png)
...
![Указываем параметры подключения](/resources/Backup/Backup3.png)

Dbeaver предложит скачать необходимые драйвера, нажмите Скачать

![Скачиваем необходимые драйвера](/resources/Backup/Backup4.png)

Появится окно об успешном прохождении теста, нажмите ОК

![Нажимаем готово](/resources/Backup/Backup5.png)

На запрос о создании образца базы данных выберите Нет

![Нажимаем "Нет"](/resources/Backup/Backup6.png)

В левой части окна будет доступно подключение с пустой базой данных

![Папка с БД](/resources/Backup/Backup7.png)

Нажмите на иконку “папки”

![Экран восстановления](/resources/Backup/Backup8.png)
...
![Выбираем файл с Backup'ом](/resources/Backup/Backup9.png)

Нажмите “Локальный клиент”

![Нажимаем локальный клиент](/resources/Backup/Backup10.png)

Выберите клиент PostgreSQL Binaries

![Выберите клиент PostgreSQL Binaries](/resources/Backup/Backup11.png)

Нажмите Старт

![Нажмите Старт](/resources/Backup/Backup12.png)
...
![Нажмите OK](/resources/Backup/Backup13.png)

Нажмите Закрыть

![Нажмите Закрыть](/resources/Backup/Backup14.png)

Теперь у Вас локально установлен сервер PostgreSQL и все необходимые базы данных для прохождения курса!

![Список схем в БД](/resources/Backup/Backup15.png)
...
![Выбираем нужную нам версию](/resources/jarInstall/Jar1.png)
...
![Открываем база данных - управление драйверами](/resources/jarInstall/Jar2.png)
...
![Выполняем установку JAR файла](/resources/jarInstall/Jar3.png)
...
![Подключение к БД](/resources/ConnectDB.png)
...
![Открываем настройки соединения](/resources/MacOS/Mac1.png)

или в настройках восстановления

![Открываем настройки восстановления](/resources/MacOS/Mac2.png)

необходимо нажать на “локальный клиент” / “Client…” и во всплывающем меню выбрать пункт “Выбрать”

![Выбираем клиент](/resources/MacOS/Mac3.png)
...
![Итоговые настройки](/resources/MacOS/Mac4.png)
